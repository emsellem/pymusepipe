...
class AlignMusePointing(object):
    ...
    def find_cross_peak(self, muse_hdu, name_musehdr):
        ...
        tmphdr = muse_hdu.header.totextfile(name_musehdr,
                                            overwrite=True)
        proj_ref_hdu = self._project_reference_hdu(name_musehdr, muse_hdu=muse_hdu)
    ...
    def _project_reference_hdu(self, name_hdr, muse_hdu=None):
        ...
        if self.use_montage:
            ...
            hdu_repr = montage.reproject_hdu(self.reference_hdu, header=name_hdr, 
                                             exact_size=True)
        else:
            # The mpdaf way
            if muse_hdu is not None:
                ...
                hdu_repre = None
                print("Warning: provide target HDU when not using montage to reproject")
